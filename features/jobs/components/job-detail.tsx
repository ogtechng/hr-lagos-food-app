...
import { RichTextRenderer } from "@/features/rich-text/components/rich-text-renderer";
...
function TextBlock({ title, content }: { title: string; content: string | null }) {
  ...
  return (
    <section className="space-y-3">
      ...
      <RichTextRenderer
        html={content}
        className="space-y-3 text-sm leading-7 text-muted-foreground [&_a]:font-medium [&_a]:text-primary [&_blockquote]:border-l-2 [&_blockquote]:pl-4 [&_img]:rounded-2xl [&_li]:ml-5 [&_ol]:list-decimal [&_ul]:list-disc"
      />
    </section>
  );
}
        ...
        <div className="space-y-5">
          ...
          <div className="max-w-3xl space-y-4">
            ...
            <RichTextRenderer
              ...
              fallback="Open role across the Produce for Lagos hiring network."
              className="space-y-3 text-lg leading-8 text-muted-foreground [&_a]:font-medium [&_a]:text-primary [&_blockquote]:border-l-2 [&_blockquote]:pl-4 [&_img]:rounded-2xl [&_li]:ml-5 [&_ol]:list-decimal [&_ul]:list-disc"
            />
          </div>
        </div>
